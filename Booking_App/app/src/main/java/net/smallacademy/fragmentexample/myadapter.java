...
public class myadapter extends FirebaseRecyclerAdapter<model,myadapter.myviewholder>
{
    ...
    DatabaseReference likereference, like_user_ref, cardview_ref;
    ...
    protected void onBindViewHolder(@NonNull final myviewholder holder, final int position, @NonNull final model model)
    {
        ...
        holder.like_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                like_user_ref = FirebaseDatabase.getInstance().getReference("User").child(userid).child("likes");
                cardview_ref = FirebaseDatabase.getInstance().getReference("restaurants").child(postkey);

                cardview_ref.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot){
                        like_data = (Map<String, String>) snapshot.getValue();
                    }
                    @Override
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(testclick==true)
                        {
                            if(snapshot.child(postkey).hasChild(userid))
                            {
                                ...
                                like_user_ref.child(postkey).removeValue();
                                testclick=false;
                            }
                            else
                            {
                                likereference.child(postkey).child(userid).setValue(true);
                                like_user_ref.child(postkey).setValue(like_data);
                                testclick=false;
                            }
